    ...
    <div className=" w-full h-auto overflow-auto">
      <div className={`${styles.paddingX} ${styles.flexCenter}`}>
        <div className={`${styles.boxWidth}`}>
          ...
          <h1 className="text-white h-[150px] text-7xl text-center mt-6 text-gradient font-bold">
           {doc.name}
          </h1>
            ...
            <div className="flex flex-col max-w-[600px] lg:max-w-[336px] ">
              <div className="items-center mb-4">
                <div className="w-full mb-6 items-center justify-center flex ">
                  ...
                  src="https://pbs.twimg.com/profile_images/1598675864270831617/6WvAnAG4_400x400.jpg"
                  ></img>
                </div>
              </div>
            ...
            <div className="flex flex-col w-full max-w-[443px]">
              <div className="bg-[#FFFFFF] rounded-[20px] p-6 w-full mb-3 dark:bg-[#33354B]">
                <div className="grid grid-cols-12">
                  <p className="mb-6 text-[18px] col-span-11 font-bold text-black md:text-[25px]">
                  {doc.name}
                  </p>
                </div>
                <p className="mb-2 font-semibold text-black">Fee</p>
                <div className="flex flex-row gap-2">
                  <img src={matic} className="h-[30px] w-[20px]" />
                  <p className="text-[20px] text-black font-bold mb-6">
                    {Number(0.02)}
                  </p>
                </div>
                <p className="mb-2 font-semibold text-black">Description</p>
                <p className="mb-6 max-w-[450px] text-[#6e6e6e]">
                {doc.description}
                </p>
                <p className="mb-2 font-semibold text-black"> Availability</p>
                {availability === true ? (
                  <div className="flex flex-row gap-4">
                    <p className="mb-6 max-w-[450px] text-[#6e6e6e] cursor-pointer">
                ...
                <p className="mb- max-w-[450px] text-[#6e6e6e]">
                  4.3/ 5
                </p>
              </div>
              {address !== docAddress ? (
