      ...
      <div className=" w-full h-auto">
        <div className={`${styles.paddingX} ${styles.flexCenter}`}>
          <div className={`${styles.boxWidth}`}>
            ...
            <h1 className="text-white h-[100px] text-6xl text-center mt-6 text-gradient font-bold">
              Register as Expert
            </h1>
                ...
                <div className="items-center mb-4">
                  <div className="w-full mb-4 items-center justify-center flex flex-col  ">
                    ...
                    <input
                      ...
                      className="m-auto outline-none mb-6 px-4 py-2 font-medium rounded-[5px] max-w-[300px] text-white bg-[#363952] sm:min-w-[330px] 
              sm:w-auto"
                      required
                    ></input>
                    <label className="text-left block text-[17px] font-medium mb-2 text-white">
                      About you (min 150 chars)
                    </label>
                    <textarea
                      id="name"
                      type="text"
              ...
              sm:w-auto"
                    ...
                    >
                      ...
                      >
                        ...
                        <MenuItem value="Psychiatrist">Gym Trainer</MenuItem>
                        <MenuItem value="Pediatrician">Crypto Trader</MenuItem>
                        <MenuItem value="Cardialogist">Politician</MenuItem>
                        <MenuItem value="ENT specialist">
                          Badminton Coach
                        </MenuItem>
                        <MenuItem value="Dentist">Mathematician</MenuItem>
                        <MenuItem value="Gynecologist">Digital Marketer</MenuItem>
                        <MenuItem value="Orthopedic Surgeon">
                          UI/UX Designer
                        </MenuItem>
                        <MenuItem value="Radiologist">Psychotherapist</MenuItem>
                        <MenuItem value="Neurologist">Lawyer</MenuItem>
